...
use bevy_mod_physx::vehicles::*;
use bevy_mod_physx::prelude as bpx;
use physx::prelude::*;
use physx::vehicles::*;
use physx_sys::{
...
fn main() {
    App::new()
        ...
        .add_plugins(bevy_mod_physx::vehicles::VehiclePlugin(default()))
        .add_plugins(common::DemoUtils) // optional
        .add_plugins(InfiniteGridPlugin)
        .add_systems(Startup, spawn_light)
        .add_systems(Startup, spawn_plane)
        .add_systems(Startup, spawn_vehicle)
        .add_systems(Update, apply_vehicle_drive_4w_controls)
        .add_systems(Update, simulate_vehicle_drive_4w_controls)
        .run();
}
